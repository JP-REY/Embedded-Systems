/*======================================================================= Biblioteca UART.h =============================================================================================
  ...
  Biblioteca destinada à configuração e inicialização de protocolo USART utilizando Ring Buffer
...
extern	volatile	uint8_t		RX_flag						,
								RX_write_index				,		//Índice de escrita do Ring Buffer RX
...
void	UART_CFG				(UART_MODE Mode , uint16_t Bps, uint8_t Speed, uint8_t Parity);		//Configura os parâmetros do protocolo USART
void	UART_INIT				(void);																//Inicializa protocolo USART
